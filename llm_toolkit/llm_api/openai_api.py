...
#     def __init__(self, api_key: str, model: str = 'gpt-4.1', url: str | None = None,
#                  store_logs: str | None = 'http_full_logs', proxy_uri: str | None = None):
#         custom_client = httpx.AsyncClient(
#             event_hooks={
#                 "request": [partial(log_request, store_logs)],
#                 "response": [partial(log_response, store_logs)],
...
#         self._model = model
#         self._model_price_for_one_token_input = MODEL_PRICES.get(self._model)['input']
#         self._model_price_for_one_token_cached = MODEL_PRICES.get(self._model)['cached']
#         self._model_price_for_one_token_output = MODEL_PRICES.get(self._model)['output']
#         self._tokenization_encoding_rule_for_model = MODEL_PRICES.get(self._model)['tokenization']
#         assert self._model_price_for_one_token_input is not None
#         assert self._model_price_for_one_token_cached is not None
#         assert self._model_price_for_one_token_output is not None
